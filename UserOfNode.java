...
public class UserOfNode {
    ...
    public static void main(String[] commandLine) {
        ...
        Node_while noNext=  new Node( new String( "mango")); // avoid interning
        ...
        Node_while nextSet = new Node(  1.618); // autobox to Double
         ...
         System.out.println(
             "2-arg constructor obviates setReferenceToNextNode");
        Node_while twoArgCon = new Node( new String( "kiwi"), nextSet);
